...
export default class BlogService {
	...
	static async getArticle(slug, userToken) {
		...
		const response = await axios.get(`https://blog-platform.kata.academy/api/articles/${slug}`, { headers })
	...
	static async updateUserProfile(userData, userToken) {
		...
		const response = await axios.put('https://blog-platform.kata.academy/api/user', { user: updatedUser }, { headers })
	...
	static async deleteArticle(slug, userToken) {
		...
		const response = await axios.delete(`https://blog-platform.kata.academy/api/articles/${slug}`, { headers })
	...
	static async unlikeArticle(slug, userToken) {
		...
		const response = await axios.delete(`https://blog-platform.kata.academy/api/articles/${slug}/favorite`, { headers })
